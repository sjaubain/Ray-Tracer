...
{
    // init some shapes
    Sphere s1(Color::black, 0.6, 0.7, Vec3(1300, 1500, 230), 220);
    Sphere s2(Color::black, 0.6, 0.7, Vec3(1800, 800, 430), 420);
    Sphere s4(Color::black, 0.6, 0.7, Vec3(3000, 3000, 630), 620);
    Sphere s3(Color::black, 0.6, 0.7, Vec3(1700, 2900, 430), 420);
    Sphere s5(Color::black, 0.6, 0.7, Vec3(3000, 1000, 330), 320);
    Sphere s6(Color::black, 0.6, 0.7, Vec3(-1700, -2900, 430), 420);
    Sphere s7(Color::black, 0.6, 0.7, Vec3(-3000, -1000, 330), 320);
    Sphere s8(Color::black, 0.6, 0.7, Vec3(-800, 100, 730), 720);
